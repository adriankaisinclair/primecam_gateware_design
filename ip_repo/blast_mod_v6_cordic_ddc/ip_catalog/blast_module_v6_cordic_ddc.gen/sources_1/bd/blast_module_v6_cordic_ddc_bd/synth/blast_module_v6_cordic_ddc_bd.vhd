...
architecture STRUCTURE of blast_module_v6_cordic_ddc_bd is
  ...
  signal accum_reset_1 : STD_LOGIC;
  ...
  signal blast_module_v6_cordic_ddc_1_accum_snap_sync : STD_LOGIC;
  ...
  signal blast_module_v6_cordic_ddc_1_ddc_snap_sync : STD_LOGIC;
  signal blast_module_v6_cordic_ddc_1_fft_of : STD_LOGIC;
  ...
  signal blast_module_v6_cordic_ddc_1_fft_snap_sync : STD_LOGIC;
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN blast_module_v6_cordic_ddc_bd_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000";
...
begin
  ...
  accum_snap_sync <= blast_module_v6_cordic_ddc_1_accum_snap_sync;
  ...
  ddc_snap_sync <= blast_module_v6_cordic_ddc_1_ddc_snap_sync;
  ...
  fft_of <= blast_module_v6_cordic_ddc_1_fft_of;
  ...
  fft_snap_sync <= blast_module_v6_cordic_ddc_1_fft_snap_sync;
  load_bins_1(10 downto 0) <= load_bins(10 downto 0);
  start_dac_1 <= start_dac;

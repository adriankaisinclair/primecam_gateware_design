...
-- Date        : Tue Dec  6 16:41:52 2022
-- Host        : entropy running 64-bit Ubuntu 20.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/adrian/vivado_projects_2022/tetra_v3/tetra_v3.srcs/sources_1/bd/bram_lutwave/ip/bram_lutwave_clk_wiz_0_1/bram_lutwave_clk_wiz_0_1_sim_netlist.vhdl
-- Design      : bram_lutwave_clk_wiz_0_1
...
entity bram_lutwave_clk_wiz_0_1_bram_lutwave_clk_wiz_0_1_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of bram_lutwave_clk_wiz_0_1_bram_lutwave_clk_wiz_0_1_clk_wiz : entity is "bram_lutwave_clk_wiz_0_1_clk_wiz";
end bram_lutwave_clk_wiz_0_1_bram_lutwave_clk_wiz_0_1_clk_wiz;

architecture STRUCTURE of bram_lutwave_clk_wiz_0_1_bram_lutwave_clk_wiz_0_1_clk_wiz is
  signal clk_in1_bram_lutwave_clk_wiz_0_1 : STD_LOGIC;
  signal clk_out1_bram_lutwave_clk_wiz_0_1 : STD_LOGIC;
...
clkin1_ibufds: unisim.vcomponents.IBUFDS
    generic map(
      ...
      I => clk_in1_p,
      IB => clk_in1_n,
      O => clk_in1_bram_lutwave_clk_wiz_0_1
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_bram_lutwave_clk_wiz_0_1,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_bram_lutwave_clk_wiz_0_1,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_bram_lutwave_clk_wiz_0_1,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity bram_lutwave_clk_wiz_0_1 is
  port (
    clk_out1 : out STD_LOGIC;
    clk_in1_p : in STD_LOGIC;
    clk_in1_n : in STD_LOGIC
  ...
  attribute NotValidForBitStream of bram_lutwave_clk_wiz_0_1 : entity is true;
end bram_lutwave_clk_wiz_0_1;

architecture STRUCTURE of bram_lutwave_clk_wiz_0_1 is
begin
inst: entity work.bram_lutwave_clk_wiz_0_1_bram_lutwave_clk_wiz_0_1_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1

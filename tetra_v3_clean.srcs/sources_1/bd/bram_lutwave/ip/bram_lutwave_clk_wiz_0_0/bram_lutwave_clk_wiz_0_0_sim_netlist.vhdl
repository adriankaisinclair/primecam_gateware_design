...
-- Date        : Tue Dec  6 16:13:49 2022
-- Host        : entropy running 64-bit Ubuntu 20.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/adrian/vivado_projects_2022/tetra_v3/tetra_v3.srcs/sources_1/bd/bram_lutwave/ip/bram_lutwave_clk_wiz_0_0/bram_lutwave_clk_wiz_0_0_sim_netlist.vhdl
-- Design      : bram_lutwave_clk_wiz_0_0
...
entity bram_lutwave_clk_wiz_0_0_bram_lutwave_clk_wiz_0_0_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of bram_lutwave_clk_wiz_0_0_bram_lutwave_clk_wiz_0_0_clk_wiz : entity is "bram_lutwave_clk_wiz_0_0_clk_wiz";
end bram_lutwave_clk_wiz_0_0_bram_lutwave_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of bram_lutwave_clk_wiz_0_0_bram_lutwave_clk_wiz_0_0_clk_wiz is
  signal clk_in1_bram_lutwave_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_bram_lutwave_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out2_bram_lutwave_clk_wiz_0_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_bram_lutwave_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_bram_lutwave_clk_wiz_0_0,
      O => clk_out1
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out2_bram_lutwave_clk_wiz_0_0,
      O => clk_out2
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_bram_lutwave_clk_wiz_0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_bram_lutwave_clk_wiz_0_0,
      CLKOUT0B => NLW_mmcme4_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_out2_bram_lutwave_clk_wiz_0_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity bram_lutwave_clk_wiz_0_0 is
  port (
    clk_out1 : out STD_LOGIC;
    clk_out2 : out STD_LOGIC;
    resetn : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of bram_lutwave_clk_wiz_0_0 : entity is true;
end bram_lutwave_clk_wiz_0_0;

architecture STRUCTURE of bram_lutwave_clk_wiz_0_0 is
begin
inst: entity work.bram_lutwave_clk_wiz_0_0_bram_lutwave_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
